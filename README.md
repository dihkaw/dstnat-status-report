...
## ✨ Fitur Utama
- **Real-time Specs:** Menampilkan merk CPU, sistem operasi, uptime dll.
...
1. **Clone Repositori**
   ```bash
   git clone https://github.com/dihkaw/dstnat-status-report
   cd dstnat-status-report
   ```
...
Misalnya dengan alamat: http://192.168.x.x:3000
Hasil: Local Port dan Router Port akan menunjukkan angka yang sama (3000).
3. Akses Luar Jaringan (DSTNAT)
